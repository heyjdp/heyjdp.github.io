...
```bash
$ gpg --quick-gen-key "Jas D Powell <jas@davepowell.net>" ed25519 sign 50y
...
sec  ed25519/0x97350083B861B66A 2022-02-24 Jas D Powell <jas@davepowell.net>
...
gpg: key 0x97350083B861B66A: "Jas D Powell <jas@davepowell.net>" not changed
